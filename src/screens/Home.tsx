                    ...
                    return (
                        <TouchableOpacity
                            ...
                            <View style={[styles.tabView, { backgroundColor: selectedTab == index ? Colors.SELECTED : Colors.TRANSPARENT }]}>
                                <Text style={[styles.tabTxt, { color: selectedTab == index ? Colors.BG : Colors.LIGHT }]}>{item}</Text>
                            </View>
                        </TouchableOpacity>
                    )
                })}
        ...
        return (
            <View style={styles.otherInfoView}>
                ...
                <View style={{ alignItems: "center" }}>
                    ...
                    <Text style={[styles.userNameTxt, { paddingTop: resizeUI(6) }]}>{`${todaysWeatherData[0]?.wind?.speed} km/h`}</Text>
                ...
                <View style={{ alignItems: "center" }}>
                    ...
                    <Text style={[styles.userNameTxt, { paddingTop: resizeUI(6) }]}>{todaysWeatherData[0]?.visibility}</Text>
                ...
                <View style={{ alignItems: "center" }}>
                    ...
                    <Text style={[styles.userNameTxt, { paddingTop: resizeUI(6) }]}>{`${todaysWeatherData[0]?.main?.humidity} %`}</Text>
    ...
    const renderMainInfoView = () => {
        return (
            <View style={styles.mainInfoView}>
                ...
                <Text style={[styles.date, { fontSize: resizeUI(24) }]}>{todaysWeatherData[0]?.weather[0]?.main}</Text>
    ...
    const renderHeaderView = () => {
        return (
            <View style={styles.headerView}>
                ...
                <View style={styles.profileView}>
                    <Text style={styles.userName}>
                        {context.userName.split(" ").length > 1
                            ...
                            : context.userName?.split(" ")[0]?.substring(0, 1)?.toUpperCase()}</Text>
                </View>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate("CityList", { screenName: "Home" })}>
                    <Image
